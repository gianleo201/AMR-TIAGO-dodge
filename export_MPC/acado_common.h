 ...
 * 
 *  Matrix containing 15 reference/measurement vectors of size 10 for first 15 nodes.
 */
real_t y[ 150 ];
...
/** Matrix of size: 45 x 10 (row major format) */
real_t R2[ 450 ];
...
/** Matrix of size: 720 x 3 (row major format) */
real_t E[ 2160 ];
