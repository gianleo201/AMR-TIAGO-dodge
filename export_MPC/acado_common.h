...
/** Matrix of size: 26 x 11 (row major format)
 * 
 ...
 * 
 *  Matrix containing 25 reference/measurement vectors of size 12 for first 25 nodes.
 */
real_t y[ 300 ];
...
/** Column vector of size: 3008 */
real_t objAuxVar[ 3008 ];

/** Row vector of size: 20 */
real_t objValueIn[ 20 ];

/** Row vector of size: 120 */
real_t objValueOut[ 120 ];
...
/** Matrix of size: 75 x 12 (row major format) */
real_t R2[ 900 ];
...
/** Matrix of size: 125 x 6 (row major format) */
real_t evHx[ 750 ];
...
/** Column vector of size: 125 */
real_t pacA01Dx0[ 125 ];

/** Matrix of size: 75 x 75 (row major format) */
real_t H[ 5625 ];

/** Matrix of size: 250 x 75 (row major format) */
real_t A[ 18750 ];
